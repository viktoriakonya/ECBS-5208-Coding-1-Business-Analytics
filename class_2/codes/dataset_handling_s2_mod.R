...
df <- read_csv(url("https://osf.io/y6jvb/download")) # Add download


# glimpse on data
glimpse( df ) # summarize dataset
...
df_hotels <- read_csv(paste0(data_in,"clean/hotelbookingdata.csv"))
df_hotels2 <- read_csv(url("https://osf.io/yzntm//download")) # Add download

write.xlsx( df_hotels2 , paste0( data_out , 'hotels_data_out.xlsx' ) , sheetName = "Sheet1" )
